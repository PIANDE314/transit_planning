...
def select_pseudo_labels(
    ...
    """
    Select confident positive and negative predictions for pseudo-labeling.
    """
    K_pos = cfg.get("K_pos")
    K_neg = cfg.get("K_neg")
    pos_thresh = cfg.get("pos_thresh")
    neg_thresh = cfg.get("neg_thresh")
...
def inject_noise_labels(
    ...
    """
    Correct noise in label predictions based on spatial neighborhood.
    """
